...
(function( $ ){
    ...
    methods: {
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit.validationSubmit", function (e) {
          ...
          var $allControlGroups = $form.find(".form-control");
        ...
        return this.each(function(){
          ...
          var $this = $(this),
            $controlGroup = $this.parents(".form-control").first(),
      ...
      ajax: {
        ...
        blockSubmit: true
          ...
          if (($label = $form.find("label[for=\"" + elementName + "\"]")).length) {
            message += " '" + $label.text() + "'";
          } else if (($label = $element.parents(".form-control").first().find("label")).length) {
    ...
    var value = null;
      ...
      var checkboxParent = $this.parents("form").first() || $this.parents(".form-control").first();
      if (checkboxParent) {
      ...
      var radioParent = $this.parents("form").first() || $this.parents(".form-control").first();
      if (radioParent) {
