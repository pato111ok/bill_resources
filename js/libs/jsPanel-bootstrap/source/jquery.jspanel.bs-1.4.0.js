...
(function ( $ ) {
    ...
    $.fn.jsPanel = function( config , callback ) {
        ...
        var jsPanel = $('<div class="jsPanel normalized" style="z-index:1001;display:none;">'+
                            '<nav class="jsPanel-navbar-hdr navbar navbar-inverse" role="navigation">'+
                            ...
                            '<div class="jsPanel-ftr" style="display:none;">'+
                                '<nav class="jsPanel-navbar-ftr navbar navbar-inverse" role="navigation">'+
                                    '<!-- Collect the nav links, forms, and other content for toggling -->'+
                                    '<div class="collapse navbar-collapse">'+
        ...
        {
            var zi = $('.jsPanel-backdrop' ).css('z-index') + 1000;
