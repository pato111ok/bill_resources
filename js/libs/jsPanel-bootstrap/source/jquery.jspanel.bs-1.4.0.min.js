...
p&&"bootstrap-rtl"!=p||l.css("float","left"),"string"==typeof e[i].btnclass?l.addClass(e[i].btnclass):l.addClass("btn-sm"));b(m,s).append(l);l.bind(e[i].event,e[i].callback)}}function A(h,e){var m=b("#"+e);m&&m.fadeOut("slow",function(){h.close()})}b.fn.jsPanel=function(h,e){function m(){return b(window).scrollTop()}function s(d){b.isFunction(a.size[d])?a.size[d]=a.size[d](c):"string"==typeof a.size[d]?a.size[d]=a.size[d]:b.isNumeric(a.size[d])?a.size[d]=a.size[d]:a.size.height=b.fn.jsPanel.defaults.size[d]}
    function p(d,f){"center"===a.position[d]?a.position[d]="body"==n?(b(window)[f]()-parseInt(a.size[f]))/2+"px":(c.parent()[f]()-parseInt(a.size[f]))/2+"px":"auto"===a.position[d]?a.position[d]=25*y+10+"px":b.isFunction(a.position[d])?a.position[d]=parseInt(a.position[d](c))+"px":b.isNumeric(a.position[d])?a.position[d]+="px":a.position[d]="string"==typeof a.position[d]?a.position[d]:25*y+10+"px"}function l(b,f){var g=c.attr("id");"body"==n?"bottom"==b||"right"==b?document.getElementById(g).style[b]=
        parseInt(a.position[b])-f+"px":document.getElementById(g).style[b]=parseInt(a.position[b])+f+"px":document.getElementById(g)&&(document.getElementById(g).style[b]=a.position[b])}try{var n=this.first()[0].tagName.toLowerCase()}catch(B){console.log(B+"\nThe element you want to append the jsPanel to does not exist!")}var a=b.extend(!0,{},b.fn.jsPanel.defaults,h),y=b(".jsPanel",this.first()).length,c=b('<div class="jsPanel normalized" style="z-index:10001;display:none;"><nav class="jsPanel-navbar-hdr navbar navbar-inverse" role="navigation">\x3c!-- Brand and toggle get grouped for better mobile display --\x3e<div class="navbar-header jsPanel-header"><a class="navbar-brand jsPanel-title" href="#"></a></div>\x3c!-- Collect the nav links, forms, and other content for toggling --\x3e<div class="collapse navbar-collapse"><ul class="nav navbar-nav navbar-right jsPanel-controls"><li class="jsPanel-hdr-r-btn-min"><a   href="#"><span class="glyphicon glyphicon-minus"></span></a></li><li class="jsPanel-hdr-r-btn-max"><a   href="#"><span class="glyphicon glyphicon-fullscreen"></span></a></li><li class="jsPanel-hdr-r-btn-close"><a href="#"><span class="glyphicon glyphicon-remove"></span></a></li></ul></div>\x3c!-- /.navbar-collapse --\x3e<div class="jsPanel-hdr-tb"></div>\x3c!-- extra header toolbar --\x3e</nav><div class="jsPanel-content jsPanel-resize32 panel panel-default"><div class="panel-body"></div></div><div class="jsPanel-ftr" style="display:none;"><nav class="jsPanel-navbar-ftr navbar navbar-inverse" role="navigation">\x3c!-- Collect the nav links, forms, and other content for toggling --\x3e<div class="collapse navbar-collapse"><ul class="nav navbar-nav navbar-right" style="width:100%;"></ul></div>\x3c!-- /.navbar-collapse --\x3e</nav></div></div>');
