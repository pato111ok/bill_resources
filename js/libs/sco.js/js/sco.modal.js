	...
	$.extend(Modal.prototype, {
		show: function() {
			...
			if (!this.$modal.length) {
				this.$modal = $('<div style="background:#fff; width:90%; margin: 0 auto" class="modal fade bs-example-modal-lg in" id="' + this.options.target.substr(1) + '"><div class="modal-header"><a class="close" href="#" data-dismiss="modal">×</a><h3>&nbsp;</h3></div><div class="inner"/></div>').appendTo(this.options.appendTo).hide();
			}
