...
function esGastoSelected(){
   $(document).on("change", "input#pesgasto", function(e) {
     /* alert('hola...'); */
     if($(this).is(":checked")) {
         $("#pesactivofijo").removeAttr("checked").parent('label').removeClass('active');
   ...
   $(document).on("change", "input#pesactivofijo", function(e) {
     if($(this).is(":checked")) {
         $("#pesgasto").removeAttr("checked").parent('label').removeClass('active');
    ...
    function autosugest_product_name(){
         $('#product_name_autosug').typeahead({
                ...
                .on('typeahead:selected', function(event, datum) {
                    var url = main_path+'compras/index/insertprod';
                        $.ajax({
                            type: "POST",
                            url: url,
